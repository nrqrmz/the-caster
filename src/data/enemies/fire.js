...
export const FIRE_ENEMIES = {
  // --- Cultists (human) ---
  acolito_brasa: { key: 'acolito_brasa', tex: TEX.archer, color: COLORS.ember, hp: 20, speed: 70, damage: 9, radius: 16,
  ...
  iniciado_veloz: { key: 'iniciado_veloz', tex: TEX.villager, color: COLORS.ember, hp: 20, speed: 130, damage: 11, radius: 16,
  ...
  encapuchado_pira: { key: 'encapuchado_pira', tex: TEX.archer, color: COLORS.ash, hp: 28, speed: 55, damage: 6, radius: 17,
    movement: { type: 'kite', range: 200 }, attacks: [{ type: 'lobAoe', radius: 60, dps: 20, duration: 3000, every: 2600, telegraph: 500 }] },
  ...
  caballero_brasa: { key: 'caballero_brasa', tex: TEX.warrior, color: COLORS.emberDeep, hp: 100, speed: 75, damage: 16, radius: 18,
  ...
  sacerdote_llama: { key: 'sacerdote_llama', tex: TEX.archer, color: COLORS.totemFire, hp: 34, speed: 70, damage: 6, radius: 17,
    movement: { type: 'kite', range: 200 }, attacks: [{ type: 'summon', spawnType: 'imp_brasa', count: 2, every: 3200 }],
  ...
  salamandra: { key: 'salamandra', tex: TEX.villager, color: COLORS.salamander, hp: 20, speed: 95, damage: 9, radius: 16,
  ...
  coloso_magma: { key: 'coloso_magma', tex: TEX.miniboss, color: COLORS.emberDeep, hp: 500, speed: 35, damage: 14, radius: 30,
    movement: { type: 'chase' }, attacks: [{ type: 'lobAoe', radius: 70, dps: 24, duration: 3200, every: 2800, telegraph: 550 }],
    modifiers: [{ type: 'shielded', reduce: 0.35 }] },
  fenix_menor: { key: 'fenix_menor', tex: TEX.miniboss, color: COLORS.salamander, hp: 250, speed: 80, damage: 10, radius: 20,
    movement: { type: 'orbit' }, attacks: [{ type: 'shootBurst', burst: 3, burstGap: 130, every: 2400, speed: 260 }],
    modifiers: ['reviveOnce'] },

  // --- Summoned / ambient ---
  imp_brasa: { key: 'imp_brasa', tex: TEX.villager, color: COLORS.ember, hp: 20, speed: 120, damage: 8, radius: 16,
    movement: { type: 'zigzag' }, attacks: [{ type: 'melee' }] },
